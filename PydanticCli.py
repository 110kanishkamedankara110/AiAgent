...
from MusicPlayer import music_player_agent, MusicDeps
from ShortLinkAgent import ShortLink_Agent
from pydantictest import Deps, github_agent
...
class CLI:
    ...
    async def chat(self):
        print("ShortLink Agent CLI (type 'quit' to exit)")
